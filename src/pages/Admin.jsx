...
const AdminDashboard = () => {
  ...
  const [destinationForm, setDestinationForm] = useState({
    title: '', description: '', image: null, departure_city_id: '',
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-md mb-6 sm:mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="relative">
                  ...
                  >
                    <Upload size={18} />
                    <span className="text-gray-600">{destinationForm.image ? destinationForm.image.name : 'Choisir une image'}</span>
                  </label>
                </div>
                <select
                ...
                <textarea
                  ...
                  className="col-span-1 md:col-span-2 px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
                  rows="3"
                />
                <button
              ...
              {destinations.map(dest => (
                <div key={dest.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 mb-2 line-clamp-2">{dest.description}</p>
                    <div className="flex justify-between items-center mb-3">
                      <span className="text-xs sm:text-sm text-gray-500">{dest.min_people}-{dest.max_people} pers.</span>
                    </div>
                    <button
