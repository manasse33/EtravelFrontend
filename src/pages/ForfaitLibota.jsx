...
import { Menu, X, Globe, Phone, Mail, MapPin, Facebook, Instagram, Twitter, Linkedin, Utensils, Home, Car, Ship, Map, ArrowRight, DollarSign, Check, ChevronLeft, ChevronRight } from 'lucide-react';

// --- Composant Header et Footer dupliqués de Home.jsx pour la cohérence de la page ---
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
                ...
                <nav className="hidden md:flex items-center space-x-10">
                    ...
                    {/* Lien modifié pour coller à la structure de Home.jsx pour OUIKENAC */}
...
// --- Composant principal du Forfait LIBOTA ---
...
const ForfaitLibota = () => {
    ...
    const tarification = [
        { depart: 'Brazzaville (+transport)', tarif: '650.000', device: 'XAF', link: '#' },
        { depart: 'Pointe noire (+transport)', tarif: '370.000', device: 'XAF', link: '#' },
        { depart: 'Kinshasa', tarif: '1.460', device: 'USD', link: '#' },
    ];
        ...
        <div className="min-h-screen bg-white font-sans">
            ...
            <div className="pt-24 pb-12 bg-gray-100 text-center shadow-inner">
                <h1 className="text-5xl md:text-6xl font-black text-gray-900 uppercase">
                    Forfait <span className="text-blue-600">LIBOTA</span>
                </h1>
            </div>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="bg-gray-50 p-8 rounded-xl shadow-lg border border-gray-200 mb-12">
                            ...
                            <ul className="space-y-3 list-none p-0">
                                ...
                                <li className="flex items-start gap-3 text-lg text-gray-700">
                                    <Check className="text-green-600 flex-shrink-0 mt-1" size={20} />
                                    <span>Randonnée d'exploration de la piste des caravanes</span>
                                </li>
                                <li className="flex items-start gap-3 text-lg text-gray-700">
                                    <Check className="text-green-600 flex-shrink-0 mt-1" size={20} />
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            <div className="overflow-hidden rounded-xl shadow-xl">
                                {/* NOTE : Remplacez par vos vraies images */}
                                <img 
                                    src="images/images/photo famille noir.jpg" 
                                    alt="Photo Famille" 
                            ...
                            <div className="overflow-hidden rounded-xl shadow-xl">
                                {/* NOTE : Remplacez par vos vraies images */}
                                <img 
                                    src="images/images/bateau pointe indienne.jpg" 
                                    alt="Bateau Pointe Indienne" 
                                    className="w-full h-80 object-cover hover:scale-105 transition-transform duration-500"
                                />
                            </div>
                        </div>
